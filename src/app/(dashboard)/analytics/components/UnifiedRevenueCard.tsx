...
/**
 * UnifiedRevenueCard - Hero card showing total revenue with stacked area chart
 * Shows revenue breakdown by platform (Shopify, TikTok, Amazon)
 */
export function UnifiedRevenueCard() {
  ...
  return (
    <Card hoverable padding="lg">
      <CardHeader>
        <CardTitle>Unified Revenue</CardTitle>
      </CardHeader>
      <CardContent>
        {/* Large metric */}
        <div className="mb-4">
        ...
        <div className="flex items-center gap-4 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[var(--text-secondary)]">
              Shopify {platformPercentages.shopify}%
            </span>
          </div>
          <div className="flex items-center gap-2">
            <PlatformBadge platform="tiktok" variant="dot" />
            <span className="text-[var(--text-secondary)]">
              TikTok {platformPercentages.tiktok}%
            </span>
          </div>
          <div className="flex items-center gap-2">
            <PlatformBadge platform="amazon" variant="dot" />
            <span className="text-[var(--text-secondary)]">
              Amazon {platformPercentages.amazon}%
            </span>
          </div>
        </div>
      </CardContent>
